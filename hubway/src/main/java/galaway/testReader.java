...
//	private static ArrayList<Trip> extractTripCSV(String trips) {
//		
//	}
        ...
        try{
            ...
            while(inputStream.hasNextLine()){
                ...
                if (splited.length <= 6)
                {
                    ...
                    try{
                    	station.install_date= stationDF.parse(splited[7]) ; 
                    	station.last_day = stationDF.parse(splited[8]) ;
